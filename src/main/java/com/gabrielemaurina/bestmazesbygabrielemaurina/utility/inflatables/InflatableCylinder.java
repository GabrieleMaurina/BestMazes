...
public class InflatableCylinder extends Inflatable{
    ...
    protected static final boolean FIRST = false;
    protected static final boolean SECOND = true;
    ...
    protected double distPointLine(Point3D point){
    ...
    protected double distPointPoint(double x1, double y1, double z1, double x2, double y2, double z2){
        x1 -= x2;
        y1 -= y2;
        z1 -= z2;
    ...
    protected double distPointPlane(Point3D point, boolean plane){
